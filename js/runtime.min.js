var now = new Date();
function createtime() {
  var t = new Date("01/17/2023 00:00:00");
  ...
  // (g =
  //   r < 18 && r >= 9
  //     ? `<img class='boardsign' src='' title='距离月入25k也就还差一个大佬带我~'><span class='textTip'> <br> 本站居然运行了 ${a} 天</span><span id='runtime'> ${r} 小时 ${i} 分 ${l} 秒 </span> <i class='fas fa-heartbeat' style='color:red'></i>`
